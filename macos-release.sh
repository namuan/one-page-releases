...
mv ../one-page/dist/OnePage.app ${OUTPUT_FOLDER}
...
xcrun altool --notarize-app -f ${ZIPPED_APP_NAME} --primary-bundle-id dev.deskriders.onepage -u ${USER} -p "@keychain:${KEYCHAIN}"
