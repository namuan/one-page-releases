...
REM ......................run pyinstaller......................
"%PYPATH%\scripts\pyinstaller.exe" --clean onepage.win%ARCH%.spec

if exist "dist\onepage.exe" (
    REM ......................add metadata to built Windows binary......................
    .\verpatch.exe dist\onepage.exe /va %APPVER%.0 /pv %APPVER%.0 /s desc "Simple ScratchPad" /s name "OnePage" /s copyright "(c) 2019 DR" /s product "OnePage %BINARCH%" /s company "deskriders.dev"
